...
This custom connector extracts metadata from Snowflake databases into [Knowledge Catalog](https://cloud.google.com/dataplex/docs/introduction).
...
|empty_comments_overwrite|If included, even when Snowflake object comments are empty they will overwrite table, view and column descriptions in Knowledge Catalog|False|OPTIONAL|
