 ...
 * A sample metadata file generated by the connector: [databricks-output.jsonl](databricks-output.jsonl)
...
* In metadata_import_request.json:
    ...
    3. Navigate to the Knowledge Catalog UI. Ensure the Entry Group, Entry Types and Aspect Types seen in metadata_import_request.json exist in your project
