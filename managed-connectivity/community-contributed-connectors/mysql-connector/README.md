...
Dataplex can collect metadata automatically from MySQL databases running on [Cloud SQL](https://cloud.google.com/sql/mysql) and this connector is not required. See [catalog integration](https://cloud.google.com/sql/docs/mysql/dataplex-catalog-integration) for details about Cloud SQL integration with Dataplex.
