...
This custom connector extracts metadata from MySQL databases for import into [Knowledge Catalog](https://cloud.google.com/dataplex/docs/introduction).
...
Note this connector is not required for databases running on [Cloud SQL](https://cloud.google.com/sql/mysql) as Knowledge Catalog can collect metadata automatically. See [Manage your Cloud SQL resources using Knowledge Catalog](https://cloud.google.com/sql/docs/mysql/dataplex-catalog-integration) for details about Cloud SQL integration with Dataplex.
...
To manually import a metadata import file generated by this connector into Knowledge Catalog see the documentation [Import metadata using a custom pipeline](https://cloud.google.com/dataplex/docs/import-metadata#import-metadata) for instructions on calling the API and considerations when importing custom metadata.
