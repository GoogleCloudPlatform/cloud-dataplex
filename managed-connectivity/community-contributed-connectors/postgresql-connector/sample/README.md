 ...
 * A sample metadata file generated by the connector: [postgres-metadata-sample.jsonl](postgres-metadata-sample.jsonl)
...
* In [postgres-metadata-sample.jsonl](postgres-metadata-sample.jsonl): 
