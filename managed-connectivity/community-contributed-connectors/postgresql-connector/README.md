...
Note that metadata for PostgreSQL instances running on [Cloud SQL](https://cloud.google.com/sql/postgresql) is collected automatically and this connector is not required for these. See [catalog integration](https://cloud.google.com/sql/docs/postgresql/dataplex-catalog-integration) for details.
