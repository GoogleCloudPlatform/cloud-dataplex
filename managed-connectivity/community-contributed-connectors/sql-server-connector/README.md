...
Note that metadata for Sql Server instances running on [Cloud SQL](https://cloud.google.com/sql/sqlserver) is collected automatically and this connector does not need to be used. See [catalog integration](https://cloud.google.com/sql/docs/sqlserver/dataplex-catalog-integration) for details.
